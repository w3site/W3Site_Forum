...
$this->getConnection()->addColumn($this->getTable('w3site_forum/forum'),
    'order',
    array(
...
$this->getConnection()->addColumn($this->getTable('w3site_forum/subject'),
    'customer_id',
    array(
        'type' => Varien_Db_Ddl_Table::TYPE_INTEGER,
        'nullable' => true,
...
$this->getConnection()->addColumn($this->getTable('w3site_forum/message'),
    'appeal',
    array(
        'type' => Varien_Db_Ddl_Table::TYPE_BOOLEAN,
        'default' => 0,
