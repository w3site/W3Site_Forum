 ...
 */
class W3Site_Forum_Block_Admin_Forum_List extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        $this->_blockGroup = 'w3site_forum';
        $this->_controller = 'admin_forum_list';
        $this->_headerText = Mage::helper('w3site_forum')->__('Forums');
