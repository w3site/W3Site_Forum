 ...
 */
class W3Site_Forum_Block_Admin_Forum_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $forumModel = Mage::registry('w3site_forum_form');
