...
/**
 * Subject edit conteiner
 *
 * @category   W3Site
 * @package    W3Site_Forum
 * @author     Teretea Alexander <tereta@mail.ua>
 */
class W3Site_Forum_Block_Admin_Subject_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
        parent::getBackUrl();
        return $this->getUrl('*/forum/subject');
    }
    
    public function getDeleteUrl()
    {
        return $this->getUrl('*/forum/subjectDelete', array($this->_objectId => $this->getRequest()->getParam($this->_objectId)));
    }
    
    public function addMessageAddButton($subjectId){
        $this->_addButton('add_message', array(
            'label'     => Mage::helper('adminhtml')->__('Add Message'),
            'onclick'   => 'setLocation(\'' . Mage::helper("adminhtml")->getUrl('*/*/messageEdit', array('subject_id' => $subjectId)) . '\')',
            'class'     => 'add',
        ), -1);
    }
