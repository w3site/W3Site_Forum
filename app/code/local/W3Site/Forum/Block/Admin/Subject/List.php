...
/**
 * Subject list conteiner
 *
 * @category   W3Site
 * @package    W3Site_Forum
 * @author     Teretea Alexander <tereta@mail.ua>
 */
class W3Site_Forum_Block_Admin_Subject_List extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        $this->_blockGroup = 'w3site_forum';
        $this->_controller = 'admin_subject_list';
        $this->_headerText = Mage::helper('w3site_forum')->__('Subjects');
    ...
    {
        return $this->getUrl('*/*/subjectEdit');
    }
}
?>