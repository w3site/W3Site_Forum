 ...
 */
class W3Site_Forum_Block_Admin_Subject_List_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('w3site_forum_subject_list_grid');
    ...
    {
        $collection = Mage::getModel('w3site_forum/subject')->getCollection();
    ...
    {
        return $this->getUrl('*/*/subject', array('_current'=>true));
    }
    
    public function getRowUrl($row)
    {
        return $this->getUrl('*/*/subjectEdit', array('id' => $row->getId()));
    }
}